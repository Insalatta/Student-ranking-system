...
function AddStudent(){
    ...
    const handleClick=(e)=>{
        e.preventDefault();
        const student = {name,sno,admissionNo,dob,aadharNo,address,bloodGrp,accNo,phone};
        ...
        <form className={"stuWrapper"}>
            ...
            <div className={"stuSubElements"}>
                <div className={"stuElements"}>
                    <input className={"fieldElements"} placeholder="Serial No"  type="text" value={sno} onChange={(e) => setSno(e.target.value) } />
                </div>
            </div>
            <div className={"stuSubElements"}>
                <div className={"stuElements"}>
